...
**Cấu trúc JSON bắt buộc:**
{
  ...
  "ds": [
    {
      "ttb": "Tên thiết bị",
      "model": "Model (nếu có, không bao gồm số REF)",
      "ref": "Số REF (Reference number, nếu có)",
      "hang": "Hãng",
      "nsx": "Nước sản xuất",
      "dvt": "Đơn vị tính",
...
7. Nhận diện chính xác số Seri và số REF (Reference number) của thiết bị nếu có.
"""
...
def main():
    ...
    if uploaded_file:
        ...
        with st.spinner("Đang trích xuất dữ liệu..."):
            data = extract_from_image(file_bytes, mime, PROMPT_TEMPLATE, pre_extracted_text=pdf_text)
